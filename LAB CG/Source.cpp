...
void frontscreen(void)
{
	...
	glClearColor(0.5, 1.5, 1.1, 0);/*background for cover page*/
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(1, 0, 0);
	drawstring(450.0, 700.0, 0.0, "KATHMANDU UNIVERSITY");
	glColor3f(0.7, 0, 1);
	...
	glColor3f(0, 0, 0);
	drawstring(100, 300, 0.0, "ISHAN KARKI");
	glColor3f(0, 0, 0);
	drawstring(100, 240, 0.0, "ROLL \t\t 18");
	glColor3f(1, 0.5, 0);
	drawstring(980, 400, 0.0, "SUBMITTED TO :");
	glColor3f(0, 0, 0);
	drawstring(930, 300, 0.0, "DHIRAJ SHRESTHA");
	glColor3f(0, 0, 0);
	drawstring(930, 240, 0.0, "ASSISTANT PROFESSOR");
	glColor3f(1, 0.1, 1);
